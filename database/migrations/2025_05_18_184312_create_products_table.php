...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->float('product_gst')->default(0);           // Added nullable()
            $table->float('final_price')->nullable();         // Added nullable()
            $table->string('main_image')->nullable();           // Added nullable()
            $table->float('product_weight')->default(0);        // Added nullable()
            ...
            $table->integer('stock')->default(0);                // Added nullable()
            $table->integer('sort')->default(0);                 // Added nullable()
