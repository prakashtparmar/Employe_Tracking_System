<aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="light">
   ...
   <div class="sidebar-brand">
      ...
      <a href="./index.html" class="brand-link">
         ...
         <!--end::Brand Image-->
         <!--begin::Brand Text-->
         <span class="brand-text fw-light">E.T.System</span>
         <!--end::Brand Text-->
      </a>
      <!--end::Brand Link-->
   </div>
      ...
      <nav class="mt-2">
         ...
         <ul
            ...
            <!-- <li class="nav-item menu-open">
               <a href="#" class="nav-link {{ Session::get('page') == '#' ? 'active' : '' }}">
            ...
            @php
                $adminManagementPages = ['update-password', 'update-details', 'subadmins', 'categories'];
            @endphp

            <li class="nav-item {{ in_array(Session::get('page'), $adminManagementPages) ? 'menu-open' : '' }}">
              <a href="#" class="nav-link {{ in_array(Session::get('page'), $adminManagementPages) ? 'active' : '' }}">
                  <i class="nav-icon bi bi-person-gear"></i>
                  <p>
                    Admin Management
                    <i class="nav-arrow bi bi-chevron-right"></i>
