...
class PasswordRequest extends FormRequest
{
    ...
    {
        return [
            'current_pwd' => ['required','string','min:5'],
    ...
    public function messages(){
        return [
            ...
            'current_pwd.min' => 'Current password must be atlist 6 characters.',
            'new_pwd.required' => 'New password is required.',
            'new_pwd.min' => 'New password must be atlist 6 characters..',
            ...
            'confirm.pwd.same' => 'Confirm password must match the new password.',
        ];
    }
}
